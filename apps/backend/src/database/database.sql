...
INSERT INTO "Staff" ("id", "staff_number", "first_name", "last_name", "role_id", "created_at", "updated_at") VALUES
(1, 'STF001', 'John', 'Smith', 1, NOW(), NOW()),
(2, 'STF002', 'Sarah', 'Johnson', 2, NOW(), NOW()),
(3, 'STF003', 'Michael', 'Williams', 3, NOW(), NOW()),
(4, 'STF004', 'Emily', 'Brown', 1, NOW(), NOW()),
(5, 'STF005', 'David', 'Jones', 2, NOW(), NOW()),
(6, 'STF006', 'Lisa', 'Garcia', 3, NOW(), NOW()),
(7, 'STF007', 'James', 'Miller', 1, NOW(), NOW()),
(8, 'STF008', 'Patricia', 'Davis', 2, NOW(), NOW()),
(9, 'STF009', 'Robert', 'Rodriguez', 3, NOW(), NOW()),
(10, 'STF010', 'Jennifer', 'Martinez', 1, NOW(), NOW());
